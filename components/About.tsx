...
const About = () => {
  return (
    <div className="mt-[-3rem] bg-[#1e293b] pb-[2rem]">
        <div className="w-[70%] pt-[2rem] sm:pt-[2rem] md:pt-2 mx-auto grid items-center grid-cols-1 lg:grid-cols-2 gap-[2rem]">
            <div>
                <h1 className="xl:text-[50px] font-bold text-yellow-300">About Me</h1>
                <p className="lg:text-[20px] text-white"> I am a driven and innovative computer science student currently studying at Conestoga College 
                    ...
                    I have honed my skills in coding languages such as C#, ASP.NET, and JavaScript, 
